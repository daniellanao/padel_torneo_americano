...
import { faSave, faTimes, faLayerGroup } from '@fortawesome/free-solid-svg-icons';
...
export default function GroupForm({ group, onSubmit, onCancel, isLoading }: GroupFormProps) {
